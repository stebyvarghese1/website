...
```text
website/
├── index.html           # Main landing page (SEO, OpenGraph, accessible)
├── README.md            # Deployment documentation (this file)
├── css/
│   └── styles.css       # Complete Cyber-HUD design system & animations
├── js/
│   ├── simulator.js     # Live threat simulator & Why? Explainability modal
│   └── main.js          # Navigation, event decoder, FAQ accordion, clipboard copy
└── assets/              # Self-contained icons and emblems (16px to 512px)
    ├── threatlens.png
    ├── threatlens.ico
    ├── threatlens_512.png
    └── screenshots/
